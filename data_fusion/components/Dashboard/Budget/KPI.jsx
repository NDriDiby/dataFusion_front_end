...
function KPI() {
  const KPIdata = [
    { title: "Marketing", value: "$50,000", icon: <FaShoppingCart />, bgColor: "bg-white" },
    { title: "Finances", value: "$120,000", icon: <FaDollarSign />, bgColor: "bg-white" },
    { title: "Sales", value: "$80,000", icon: <FaChartLine />, bgColor: "bg-white" },
    { title: "Other", value: "$25,000", icon: <FaShoppingCart />, bgColor: "bg-white" },
