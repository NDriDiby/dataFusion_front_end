...
function forgetPassword() {
  ...
  const handleResetPassword = async (e, email, password1, password2) => {
    e.preventDefault();
    ...
    try {
      ...
      setErrorMessage("Password rest successfuly");
      setTimeout(() => {
        ...
        <form>
          ...
          <div className="mt-3 px-2">
            {!existingUser ? (
              ...
              <button onClick={(e) => handleResetPassword(e, email, password1, password2)} className="w-full py-2  bg-[#394592] text-white rounded-md hover:bg-gray-700">
                Reset password
              </button>
            )}
          </div>
